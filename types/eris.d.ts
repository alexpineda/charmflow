...
declare namespace Eris {
  ...
  type InteractionEditContent = Pick<
    WebhookPayload,
  ...
  > {
    ...
    description: T extends Constants["ApplicationCommandTypes"]["CHAT_INPUT"]
      ? string
      : never;
  ...
  type AnyApplicationCommand =
    | ChatInputApplicationCommand
    | MessageApplicationCommand
    | UserApplicationCommand;
  type ChatInputApplicationCommand = ApplicationCommand<
    Constants["ApplicationCommandTypes"]["CHAT_INPUT"]
  >;
  type UserApplicationCommand = Omit<
    ApplicationCommand<Constants["ApplicationCommandTypes"]["USER"]>,
    "description" | "options"
  >;
  type MessageApplicationCommand = Omit<
    ApplicationCommand<Constants["ApplicationCommandTypes"]["MESSAGE"]>,
    "description" | "options"
  >;
  ...
  type ChatInputApplicationCommandStructure = Omit<
    ChatInputApplicationCommand,
    "id" | "application_id" | "guild_id"
  >;
  type MessageApplicationCommandStructure = Omit<
    MessageApplicationCommand,
    "id" | "application_id" | "guild_id"
  >;
  type UserApplicationCommandStructure = Omit<
    UserApplicationCommand,
    "id" | "application_id" | "guild_id"
  >;
  ...
  type BotActivityType = Constants["ActivityTypes"][Exclude<
    keyof Constants["ActivityTypes"],
    "CUSTOM"
  >];
  type FriendSuggestionReasons = {
    name: string;
  ...
  // Webhook
  type MessageWebhookContent = Pick<
    WebhookPayload,
    "content" | "embeds" | "file" | "allowedMentions" | "components"
  >;
  ...
  interface EditChannelOptions
    extends Omit<CreateChannelOptions, "permissionOverwrites" | "reason"> {
    archived?: boolean;
  ...
  interface RequestGuildMembersOptions
    extends Omit<FetchMembersOptions, "userIDs"> {
    nonce: string;
    user_ids?: string[];
  }
  ...
  interface InteractionButton extends ButtonBase {
    custom_id: string;
    style: Constants["ButtonStyles"][Exclude<
      keyof Constants["ButtonStyles"],
      "LINK"
    >];
  }
  ...
  interface Constants {
    ...
    GuildIntegrationTypes: ["twitch", "youtube", "discord"];
    GuildNSFWLevels: {
      DEFAULT: 0;
      EXPLICIT: 1;
      SAFE: 2;
  ...
  type ConnectionVisibilityTypes =
    Constants["ConnectionVisibilityTypes"][keyof Constants["ConnectionVisibilityTypes"]];
  ...
  export class CategoryChannel extends GuildChannel {
    ...
    edit(
      options: Omit<CreateChannelOptions, "permissionOverwrites" | "reason">,
      reason?: string
    ): Promise<this>;
  }
  ...
  export class Client extends EventEmitter {
    ...
    enableSelfMFATOTP(
      ...
      backup_codes: { code: string; consumed: boolean }[];
      token: string;
    }>;
    executeSlackWebhook(
      webhookID: string,
  ...
  export class GuildChannel extends Channel {
    ...
    edit(
      options: Omit<EditChannelOptions, "icon" | "ownerID">,
      reason?: string
    ): Promise<this>;
    editPermission(
      overwriteID: string,
  ...
  > extends Interaction {
    ...
    editMessage(
      messageID: string,
      content: string | InteractionEditContent,
      file?: FileContent | FileContent[]
    ): Promise<Message>;
    editOriginalMessage(
      content: string | InteractionEditContent,
  ...
  > extends Interaction {
    ...
    editParent(
      content: InteractionEditContent,
      file?: FileContent | FileContent[]
    ): Promise<void>;
    getOriginalMessage(): Promise<Message>;
  }
  ...
  > extends Base {
    ...
    tts: boolean;
    type: number;
    webhookID: T extends GuildTextableWithThread
      ? string | undefined
      : undefined;
    constructor(data: BaseData, client: Client);
  ...
  export class NewsChannel extends TextChannel {
    ...
    createInvite(
      options?: CreateInviteOptions,
      reason?: string
    ): Promise<Invite<"withMetadata", NewsChannel>>;
    createMessage(
      content: MessageContent,
      file?: FileContent | FileContent[]
  ...
  export class NewsThreadChannel extends ThreadChannel {
    ...
    createMessage(
      content: MessageContent,
      file?: FileContent | FileContent[]
    ): Promise<Message<NewsThreadChannel>>;
    edit(
      options: Pick<
        EditChannelOptions,
        | "archived"
  ...
  export class PrivateThreadChannel extends ThreadChannel {
    ...
    createMessage(
      content: MessageContent,
      file?: FileContent | FileContent[]
    ): Promise<Message<PrivateThreadChannel>>;
    edit(
      options: Pick<
        EditChannelOptions,
        | "archived"
  ...
  export class PublicThreadChannel extends ThreadChannel {
    ...
    createMessage(
      content: MessageContent,
      file?: FileContent | FileContent[]
    ): Promise<Message<PublicThreadChannel>>;
    edit(
      options: Pick<
        EditChannelOptions,
        | "archived"
  ...
  export class Relationship
    extends Base
    implements Omit<Presence, "activities">
  {
    activities: Activity[] | null;
    clientStatus?: ClientStatus;
    id: string;
  ...
  export class TextChannel
    ...
    implements GuildTextable, Invitable
  {
    defaultAutoArchiveDuration: AutoArchiveDuration;
    lastMessageID: string;
    lastPinTimestamp: number | null;
    ...
    createInvite(
      options?: CreateInviteOptions,
      reason?: string
    ): Promise<Invite<"withMetadata", TextChannel>>;
    createMessage(
      content: MessageContent,
      file?: FileContent | FileContent[]
  ...
  export class VoiceChannel extends GuildChannel implements Invitable {
    ...
    createInvite(
      options?: CreateInviteOptions,
      reason?: string
    ): Promise<Invite<"withMetadata", VoiceChannel>>;
